...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/audio/alaudiosourcelocalization.html#alaudiosourcelocalization">NAOqi APIs for ALAudioSourceLocalization </a>
* NAOqi V2.3.x
*/
public class ALAudioSourceLocalization extends ALProxy {

    private AsyncALAudioSourceLocalization asyncProxy;

    public ALAudioSourceLocalization(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALAudioSourceLocalization();
     ...
     *
	 * @return a AsyncALAudioSourceLocalization object
	 */
    public AsyncALAudioSourceLocalization async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALAudioSourceLocalization extends ALProxy {
        ...
        protected AsyncALAudioSourceLocalization(){
            super();
        }
