...
public class ALFaceCharacteristics extends ALProxy {
    ...
    private AsyncALFaceCharacteristics asyncProxy;

    public ALFaceCharacteristics(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALFaceCharacteristics();
     ...
     *
	 * @return a AsyncALFaceCharacteristics object
	 */
    public AsyncALFaceCharacteristics async() {
        return asyncProxy;
    }
    ...
    */
    public void setSmilingThreshold(Float threshold) throws CallError, InterruptedException{
        call("setSmilingThreshold", threshold).get();
    }
    ...
    */
    ...
    public class AsyncALFaceCharacteristics extends ALProxy {
        ...
        protected AsyncALFaceCharacteristics(){
            super();
        }
    ...
    * @return The Future
    */
    public Future<Void> setSmilingThreshold(Float threshold) throws CallError, InterruptedException{
        return call("setSmilingThreshold", threshold);
    }
