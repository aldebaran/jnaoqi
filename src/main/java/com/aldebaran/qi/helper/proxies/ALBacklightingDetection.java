...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/vision/albacklightingdetection.html#albacklightingdetection">NAOqi APIs for ALBacklightingDetection </a>
* NAOqi V2.3.x
*/
public class ALBacklightingDetection extends ALProxy {

    private AsyncALBacklightingDetection asyncProxy;

    public ALBacklightingDetection(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALBacklightingDetection();
     ...
     *
	 * @return a AsyncALBacklightingDetection object
	 */
    public AsyncALBacklightingDetection async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALBacklightingDetection extends ALProxy {
        ...
        protected AsyncALBacklightingDetection(){
            super();
        }
