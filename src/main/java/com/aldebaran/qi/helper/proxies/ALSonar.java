...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/sensors/alsonar.html#alsonar">NAOqi APIs for ALSonar </a>
* NAOqi V2.3.x
*/
public class ALSonar extends ALProxy {

    private AsyncALSonar asyncProxy;

    public ALSonar(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALSonar();
     ...
     *
	 * @return a AsyncALSonar object
	 */
    public AsyncALSonar async() {
        return asyncProxy;
    }
    ...
    */
    public List<Float> getFilteredValues() throws CallError, InterruptedException {
        return (List<Float>)call("getFilteredValues").get();
    }


    public class AsyncALSonar extends ALProxy {

        protected AsyncALSonar(){
            super();
        }
    ...
    * 
    */
    public Future<List<Float>> getFilteredValues() throws CallError, InterruptedException {
        return call("getFilteredValues");
    }
