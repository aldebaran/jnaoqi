...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/sensors/alsensors.html#alsensors">NAOqi APIs for ALSensors </a>
* NAOqi V2.3.x
*/
public class ALSensors extends ALProxy {

    private AsyncALSensors asyncProxy;

    public ALSensors(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALSensors();
     ...
     *
	 * @return a AsyncALSensors object
	 */
    public AsyncALSensors async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALSensors extends ALProxy {

        protected AsyncALSensors(){
            super();
        }
    ...
    * @return The Future
    */
    public Future<Void> run() throws CallError, InterruptedException{
        return call("run");
    }
