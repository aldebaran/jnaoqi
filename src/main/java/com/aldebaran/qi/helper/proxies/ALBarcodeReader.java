...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/vision/albarcodereader.html#albarcodereader">NAOqi APIs for ALBarcodeReader </a>
* NAOqi V2.3.x
*/
public class ALBarcodeReader extends ALProxy {

    private AsyncALBarcodeReader asyncProxy;

    public ALBarcodeReader(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALBarcodeReader();
     ...
     *
	 * @return a AsyncALBarcodeReader object
	 */
    public AsyncALBarcodeReader async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALBarcodeReader extends ALProxy {
        ...
        protected AsyncALBarcodeReader(){
            super();
        }
