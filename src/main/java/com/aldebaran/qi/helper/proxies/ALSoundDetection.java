...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/audio/alsounddetection.html#alsounddetection">NAOqi APIs for ALSoundDetection </a>
* NAOqi V2.3.x
*/
public class ALSoundDetection extends ALProxy {

    private AsyncALSoundDetection asyncProxy;

    public ALSoundDetection(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALSoundDetection();
     ...
     *
	 * @return a AsyncALSoundDetection object
	 */
    public AsyncALSoundDetection async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALSoundDetection extends ALProxy {

        protected AsyncALSoundDetection(){
            super();
        }
