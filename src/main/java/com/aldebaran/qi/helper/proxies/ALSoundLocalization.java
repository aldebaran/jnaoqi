...
* @see <a href="http://doc.aldebaran.lan/doc/release-2.3/aldeb-doc/naoqi/audio/alsoundlocalization.html#alsoundlocalization">NAOqi APIs for ALSoundLocalization </a>
* NAOqi V2.3.x
*/
public class ALSoundLocalization extends ALProxy {

    private AsyncALSoundLocalization asyncProxy;

    public ALSoundLocalization(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALSoundLocalization();
     ...
     *
	 * @return a AsyncALSoundLocalization object
	 */
    public AsyncALSoundLocalization async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALSoundLocalization extends ALProxy {

        protected AsyncALSoundLocalization(){
            super();
        }
