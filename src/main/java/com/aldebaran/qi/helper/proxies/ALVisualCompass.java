...
public class ALVisualCompass extends ALProxy {
    ...
    private AsyncALVisualCompass asyncProxy;

    public ALVisualCompass(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALVisualCompass();
     ...
     *
	 * @return a AsyncALVisualCompass object
	 */
    public AsyncALVisualCompass async() {
        return asyncProxy;
    }
 ...
 [1]: Number of keypoints matching.
    ...
    */
    ...
    public class AsyncALVisualCompass extends ALProxy {
        ...
        protected AsyncALVisualCompass(){
            super();
        }
    ...
    * @return The Future
    */
    public Future<Void> enableReferenceRefresh(Boolean refresh) throws CallError, InterruptedException{
        return call("enableReferenceRefresh", refresh);
    }
    ...
    * @param theta  Rotation around the Z axis in radians [-3.1415 to 3.1415].
    */
    public Future<Boolean> moveTo(Float x, Float y, Float theta) throws CallError, InterruptedException {
    ...
    * @param x  Algebric distance along the X axis in meters.
    */
    public Future<Boolean> moveStraightTo(Float x) throws CallError, InterruptedException {
        return call("moveStraightTo", x);
    }
    ...
    * @return The Future
    */
    public Future<Void> waitUntilTargetReached() throws CallError, InterruptedException{
        return call("waitUntilTargetReached");
    }
