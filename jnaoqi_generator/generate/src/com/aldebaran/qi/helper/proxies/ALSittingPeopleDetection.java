...
public class ALSittingPeopleDetection extends ALProxy {
    ...
    private AsyncALSittingPeopleDetection asyncProxy;

    public ALSittingPeopleDetection(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALSittingPeopleDetection();
     ...
     *
	 * @return a AsyncALSittingPeopleDetection object
	 */
    public AsyncALSittingPeopleDetection async() {
        return asyncProxy;
    }
    ...
    */
    public Float getSittingThreshold() throws CallError, InterruptedException {
        return (Float)call("getSittingThreshold").get();
    }
    ...
    */
    ...
    public class AsyncALSittingPeopleDetection extends ALProxy {
        ...
        protected AsyncALSittingPeopleDetection(){
            super();
        }
    ...
    * @return Maximum face height in meter
    */
    public Future<Float> getSittingThreshold() throws CallError, InterruptedException {
        return call("getSittingThreshold");
    }
