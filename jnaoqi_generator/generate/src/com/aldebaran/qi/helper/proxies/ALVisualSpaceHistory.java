...
public class ALVisualSpaceHistory extends ALProxy {
    ...
    private AsyncALVisualSpaceHistory asyncProxy;

    public ALVisualSpaceHistory(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALVisualSpaceHistory();
     ...
     *
	 * @return a AsyncALVisualSpaceHistory object
	 */
    ...
    */
    ...
    public class AsyncALVisualSpaceHistory extends ALProxy {
        ...
        protected AsyncALVisualSpaceHistory(){
            super();
        }
    ...
    * @return The Future
    */
    public Future<Void> resetGrid() throws CallError, InterruptedException{
        return call("resetGrid");
    }
