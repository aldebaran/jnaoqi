...
public class ALWavingDetection extends ALProxy {
    ...
    public ALWavingDetection(Session session) {
        super(session);
    }
    ...
    */
    ...
    /**
    * Gets the value of the close detection threshold (in percentage)
    * 
    * @return Current close detection threshold (in percentage)
    */
    public Float getThreshold() throws CallError, InterruptedException {
        return (Float)service.call("getThreshold").get();
    }

    /**
    * Sets the value of the threshold to raise event when waving occurs.
    * 
    * @param threshold  New close detection threshold (percentage)
    */
    public void setThreshold(Float threshold) throws CallError, InterruptedException{
        if (isAsynchronous)
            service.call("setThreshold", threshold);
        else
            service.call("setThreshold", threshold).get();
    }
