...
/**
* 
* @see <a href="http://doc.aldebaran.com/2-1/naoqi/core/albonjour.html#albonjour">NAOqi APIs for ALBonjour </a>
*
*/
public class ALBonjour extends ALProxy {

    private AsyncALBonjour asyncProxy;

    public ALBonjour(Session session) throws Exception{
        super(session);
        asyncProxy = new AsyncALBonjour();
     ...
     *
	 * @return a AsyncALBonjour object
	 */
    public AsyncALBonjour async() {
        return asyncProxy;
    }
    ...
    */
    ...
    public class AsyncALBonjour extends ALProxy {

        protected AsyncALBonjour(){
            super();
        }
